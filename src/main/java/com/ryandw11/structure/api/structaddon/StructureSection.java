 ...
 * the API using the {@link com.ryandw11.structure.api.CustomStructuresAPI#registerCustomAddon(CustomStructureAddon)}
 * method.</p>
 *
 * <p>Note: Your implementation must have a public default constructor with no parameters. That default
 * constructor should initialize your section with the default values. A second constructor for developers using your
 * custom section is optional.</p>
 *
...
public interface StructureSection /*extends StructureProperty*/ {
     ...
     * <p>This method is not called when another plugin adds your section via the
     * {@link com.ryandw11.structure.structure.StructureBuilder}.
     * So it is important that your default constructor initializes your section with the default values.</p>
     *
     * @param configurationSection The configuration section. (This is null if the section does not exist in the
     ...
     *
     * @param structure  The structure that is being spawned. (Note: it is good practice to not rely on other data from
     *                   the structure to make a decision.)
